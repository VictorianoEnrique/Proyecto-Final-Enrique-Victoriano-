...
Formato de Datos: Archivos de texto o datos (.txt o .dat) exportados de sistemas clínicos como BIOPAC o hardware embebido. Deben venir en columnas separadas por tabuladores (Columna 1: ECG, Columna 2: EMG).
...
| Estado de Calibración / Normal | Fatiga Muscular | | Captura Normal | Captura Fatiga |
